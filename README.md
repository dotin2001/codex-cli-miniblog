...
For one-off local migration checks in the API container, run:
...
The API container applies pending Flask-Migrate migrations, then runs the Flask app with Gunicorn.
